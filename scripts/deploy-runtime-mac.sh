...
Before calling live WPS tools, confirm the bridge is running and list active sessions with wps.list_sessions. For project-specific work, require the WPS session binding to match the Codex project/thread to avoid cross-window routing.
EOF_SKILL
