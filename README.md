...
- install the Codex plugin into `$HOME/.codex/plugins/cache/personal/wps-connector/1.0.87`;
...
WPS_CONNECTOR_PLUGIN_INSTALL_DIR="$HOME/.codex/plugins/cache/personal/wps-connector/1.0.87" \
...
```text
$HOME/.codex/plugins/cache/personal/wps-connector/1.0.87
```
...
- UI/clientVersion: `v1.0.87`
- clientBuild: `2026.07.19-pane-width-collapse.1`
